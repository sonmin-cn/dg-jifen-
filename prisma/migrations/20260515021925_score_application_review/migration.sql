...
INSERT INTO "new_ScoreApplication" ("id", "leaderId", "payloadJson", "rejectReason", "remark", "requestedPoints", "reviewedAt", "reviewedBy", "scoreYearId", "status", "submittedAt", "tripId", "type") SELECT "id", "leaderId", "payloadJson", "rejectReason", "remark", "requestedPoints", "reviewedAt", "reviewedBy", "scoreYearId", "status", "submittedAt", "tripId", "type" FROM "ScoreApplication";
